 ...
 if (isset($_GET['ok'])) {
		...
		if($_GET['menu']==3) { //Empresas
			...
			if($_GET['sub']==1) {
				...
				$cf = utf8_decode($_POST['cf']);
				//$dataconveni = utf8_decode($_POST['dataconveni']);
				//$notes = utf8_decode($_POST['notes']);
				$curs = utf8_decode($_POST['curs']);
				$evalua = utf8_decode($_POST['evalua']);
				$familia = utf8_decode($_POST['familia']);
				
				
				$result = $db->Execute("UPDATE CDE_empresas SET nombre = '$nombre' WHERE id = $idactu");
				//$result = $db->Execute("UPDATE CDE_empresas SET convenio = '$convenio' WHERE id = $idactu");
				$result = $db->Execute("UPDATE CDE_empresas SET gerente = '$gerente' WHERE id = $idactu");
				$result = $db->Execute("UPDATE CDE_empresas SET direccion = '$direccion' WHERE id = $idactu");
				$result = $db->Execute("UPDATE CDE_empresas SET cp = '$cp' WHERE id = $idactu");
				$result = $db->Execute("UPDATE CDE_empresas SET poblacion = '$poblacion' WHERE id = $idactu");
				$result = $db->Execute("UPDATE CDE_empresas SET provincia = '$provincia' WHERE id = $idactu");
				...
				$result = $db->Execute("UPDATE CDE_empresas SET telf1 = '$telf1' WHERE id = $idactu");
				...
				$result = $db->Execute("UPDATE CDE_empresas SET fax = '$fax' WHERE id = $idactu");
				//$result = $db->Execute("UPDATE CDE_empresas SET emailempresa = '$emailempresa' WHERE id = $idactu");
				$result = $db->Execute("UPDATE CDE_empresas SET cif = '$cif' WHERE id = $idactu");
				...
				$result = $db->Execute("UPDATE CDE_empresas SET evaluacio = '$evalua' WHERE id = $idactu");
				$result = $db->Execute("UPDATE CDE_empresas SET curs = '$curs' WHERE id = $idactu");
				$result = $db->Execute("UPDATE CDE_empresas SET familia = '$familia' WHERE id = $idactu");
...
<table width="290" border="0" align="center" cellpadding="0" cellspacing="0" class="texte_normal">
                                ...
                                <table width="290" border="0" align="center" cellpadding="0" cellspacing="0" class="texte_normal">
                                  ...
                                  <tr>
                                    ...
                                    <td bgcolor="#F8F8F8"><label>
                                      <input name="textfield" type="text" class="texte_normal" id="textfield7" value="<?php echo htmlentities($fax) ?>" />
                                    </label></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td bgcolor="#F8F8F8"><label>
                                      <input name="evalua" type="text" class="texte_normal" id="textfield5" value="<?php echo htmlentities($evalua) ?>" />
                                    </label></td>
                                  </tr>
                                  <tr>
                                    <td height="26" bgcolor="#F8F8F8">&nbsp;</td>
