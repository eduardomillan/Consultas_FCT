...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="texte_normal">
                    ...
                    <tr>
                      <td height="25" bgcolor="#F8F8F8" class="texte_mini">&nbsp;Familia 1</td>
                      <td bgcolor="#F8F8F8" class="texte_mini"><strong><?php echo utf8_encode($familia) ?></strong></td>
                      <td bgcolor="#F8F8F8" class="texte_mini">&nbsp;Familia 2</td>
                      <td bgcolor="#F8F8F8" class="texte_mini"><?php echo utf8_encode($familia2) ?></td>
                    </tr>
                    <tr>
                      <td height="25" bgcolor="#F8F8F8" class="texte_mini">&nbsp;Familia 3</td>
                      <td bgcolor="#F8F8F8" class="texte_mini"><?php echo utf8_encode($familia3) ?></td>
                      <td bgcolor="#F8F8F8" class="texte_mini">&nbsp;Familia 4</td>
                      <td bgcolor="#F8F8F8" class="texte_mini"><?php echo utf8_encode($familia4) ?></td>
                    </tr>
                  </table>
